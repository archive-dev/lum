...
final class ClassModelImpl implements ClassModel {
    ...
    final Optional<LumParser.TypeDeclarationContext> ctx;
    ...
    public ClassModelImpl(
        ...
        this(attributes, accessFlags, name, typeParameters, superClass, interfaces, members, Optional.empty());
    }
    ...
    public ClassModelImpl(
            ...
            ClassModel[] interfaces,
            Member[] members,
            Optional<LumParser.TypeDeclarationContext> ctx
    ) {
